...
@Component({
  selector: 'app-babycare-product',
  templateUrl: './babycare-product.component.html',
  styleUrls: ['./babycare-product.component.css']
})
export class BabycareProductComponent implements OnInit {
