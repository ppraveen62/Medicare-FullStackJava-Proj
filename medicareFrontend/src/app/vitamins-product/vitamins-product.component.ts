...
@Component({
  selector: 'app-vitamins-product',
  templateUrl: './vitamins-product.component.html',
  styleUrls: ['./vitamins-product.component.css']
})
export class VitaminsProductComponent implements OnInit {
