...
@Component({
  selector: 'app-personalcare-product',
  templateUrl: './personalcare-product.component.html',
  styleUrls: ['./personalcare-product.component.css']
})
export class PersonalcareProductComponent implements OnInit {
